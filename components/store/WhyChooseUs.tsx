...
export default function WhyChooseUs() {
  return (
    <section className="py-16 md:py-24 bg-[#F8F5F0] border-y border-gray-100">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="mb-8 md:mb-10">
          <p className="text-[#E63946] text-xs font-bold tracking-[0.08em] mb-2">WHY US</p>
          <h3 className="text-3xl md:text-4xl font-black tracking-tight text-[#0A0A0A]">Why Customers Choose DripStore</h3>
        </div>
