  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="mb-8 md:mb-10 flex items-end justify-between gap-4">
        <div>
          <p className="text-[#E63946] text-xs font-bold tracking-[0.08em] mb-2">JUST IN</p>
          <h2 className="text-3xl md:text-4xl font-black tracking-tight text-[#0A0A0A]">New Arrivals</h2>
        </div>
      </div>
      {loading ? (
      ...
      <div className="mt-14 md:mt-16 text-center">
        <MagneticButton className="inline-block">
          <Link
            href="/shop"
            className="group inline-flex items-center gap-3 px-11 py-4 bg-[#0A0A0A] text-white font-black text-sm tracking-[0.08em] rounded-full hover:bg-[#E63946] transition-all duration-300 hover:gap-5"
          >
            VIEW ALL PRODUCTS
