...
export default function OfferBanner() {
  return (
    <section className="px-4 md:px-8 py-10 md:py-12 max-w-7xl mx-auto">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="relative bg-[#0A0A0A] rounded-3xl overflow-hidden px-6 sm:px-8 md:px-16 py-10 md:py-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8"
      >
        ...
        <div className="relative z-10">
          ...
          <RevealText text="UP TO 50% OFF" className="text-2xl sm:text-3xl md:text-5xl font-black text-white leading-tight tracking-tight" />
